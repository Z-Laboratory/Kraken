...
class ADComputeFiniteStrainElasticStressTemplH : public ADComputeStressBaseTempl<R2>,
                                                public GuaranteeConsumer
{
public:
  static InputParameters validParams();

  ADComputeFiniteStrainElasticStressTemplH(const InputParameters & parameters);
...
typedef ADComputeFiniteStrainElasticStressTemplH<RankTwoTensor, RankFourTensor>
    H_ADComputeFiniteStrainElasticStress;
typedef ADComputeFiniteStrainElasticStressTemplH<SymmetricRankTwoTensor, SymmetricRankFourTensor>
    H_ADSymmetricFiniteStrainElasticStress;
