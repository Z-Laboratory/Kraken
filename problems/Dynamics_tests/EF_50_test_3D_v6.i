[Mesh]
    file='EF_50_test_3D_v4_checkpoint_cp/0150_mesh.cpr'
    dim=3
    use_displaced_mesh = true
    construct_side_list_from_node_list=True
[]
[Problem]
restart_file_base='EF_50_test_3D_v4_checkpoint_cp/0150'
[]
[GlobalParams]
...
[Functions]
  [./rampLineary]
    type = ParsedFunction
    value=max(if(.04<=t,15*29e-2*(.30-t),0),0)
  [] 
  
  [./rampLinearz]
    type = ParsedFunction
    value=max(if(.16<=t,24*42e-2*(.4-t),0),0)
  [] 
  
  [./rampLinear2]
    type = ParsedFunction
    value=if(t<=.15,-4e-2,0)
  [] 
    #superglue functions
  [a_regulator]
    type = ParsedFunction
