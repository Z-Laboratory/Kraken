...
[BCs]
    [Pressure]
        [stress1]
        boundary=actuator_interface # This compresses the material at the start about 28mm- which brings us to our maximum compression state that our physical trials start at
        function=rampLinear
        #factor=0
        alpha = -0.25
        use_automatic_differentiation = true
