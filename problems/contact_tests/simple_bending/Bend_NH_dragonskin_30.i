...
[Contact]
  [b1]
    ...
    model = frictionless
    penalty = .1e6 ################### this value needs to be inreased from .1e5, there is significant penetration at higher deformations. #########################
    formulation=penalty
...
[Materials]
  ...
  [elasitc_stress]
    ...
    mu=.2226e6  # compiled with proper NH formulaiton
    kappa=.2226e8
  []
    [./density1]
