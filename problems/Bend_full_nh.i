...
[Contact]
  [b1]
    ...
    model = frictionless
    penalty = 0.1e5 ################### this value needs to be inreased from .1e5, there is significant penetration at higher deformations. #########################
    formulation=penalty
...
[Materials]
  ...
  [elasitc_stress]
    ...
    mu=.754e5  # compiled with proper NH formulaiton
    kappa=1e7
  []
    [./density1]
