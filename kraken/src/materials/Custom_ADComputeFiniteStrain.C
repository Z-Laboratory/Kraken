...
#include "Custom_ADComputeFiniteStrain.h"

#include "libmesh/quadrature.h"
#include "libmesh/utility.h"

registerMooseObject("TensorMechanicsApp", Custom_ADComputeFiniteStrain);

MooseEnum
Custom_ADComputeFiniteStrain::decompositionType()
{
  return MooseEnum("TaylorExpansion EigenSolution", "TaylorExpansion");
}

InputParameters
Custom_ADComputeFiniteStrain::validParams()
{
...
Custom_ADComputeFiniteStrain::Custom_ADComputeFiniteStrain(const InputParameters & parameters)
...
void
Custom_ADComputeFiniteStrain::computeProperties()
{
...
void
Custom_ADComputeFiniteStrain::computeQpStrain()
{
...
void
Custom_ADComputeFiniteStrain::computeQpIncrements(ADRankTwoTensor & total_strain_increment,
                                           ADRankTwoTensor & rotation_increment)
{
  switch (_decomposition_method)
  {
    ...
    default:
      mooseError("Custom_ADComputeFiniteStrain Error: Pass valid decomposition type: TaylorExpansion or "
                 "EigenSolution.");
  }
}
