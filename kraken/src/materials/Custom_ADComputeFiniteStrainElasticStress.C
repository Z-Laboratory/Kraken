...
#include "Custom_ADComputeFiniteStrainElasticStress.h"

registerMooseObject("TensorMechanicsApp", Custom_ADComputeFiniteStrainElasticStress);

InputParameters
Custom_ADComputeFiniteStrainElasticStress::validParams()
{
...
Custom_ADComputeFiniteStrainElasticStress::Custom_ADComputeFiniteStrainElasticStress(
...
void
Custom_ADComputeFiniteStrainElasticStress::initialSetup()
{
}

void
Custom_ADComputeFiniteStrainElasticStress::initQpStatefulProperties()
{
...
void
Custom_ADComputeFiniteStrainElasticStress::computeQpStress()
{
