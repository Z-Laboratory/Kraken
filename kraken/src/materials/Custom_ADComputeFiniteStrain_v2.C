...
#include "Custom_ADComputeFiniteStrain_2.h"

#include "libmesh/quadrature.h"
#include "libmesh/utility.h"

registerMooseObject("TensorMechanicsApp", Custom_ADComputeFiniteStrain_2);

MooseEnum
Custom_ADComputeFiniteStrain_2::decompositionType()
{
  return MooseEnum("TaylorExpansion EigenSolution", "TaylorExpansion");
}

InputParameters
Custom_ADComputeFiniteStrain_2::validParams()
{
...
Custom_ADComputeFiniteStrain_2::Custom_ADComputeFiniteStrain_2(const InputParameters & parameters)
...
void
Custom_ADComputeFiniteStrain_2::computeProperties()
{
...
void
Custom_ADComputeFiniteStrain_2::computeQpStrain()
{
...
void
Custom_ADComputeFiniteStrain_2::computeQpIncrements(ADRankTwoTensor & total_strain_increment,
                                           ADRankTwoTensor & rotation_increment)
{
  switch (_decomposition_method)
  {
    ...
    default:
      mooseError("Custom_ADComputeFiniteStrain_2 Error: Pass valid decomposition type: TaylorExpansion or "
                 "EigenSolution.");
  }
}
