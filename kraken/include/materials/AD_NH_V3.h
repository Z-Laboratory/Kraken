...
/**
 * AD_NH_V3 computes the stress following elasticity
 * theory for finite strains
 */
class AD_NH_V3 : public ADComputeStressBase, public GuaranteeConsumer
{
public:
  static InputParameters validParams();

  AD_NH_V3(const InputParameters & parameters);
