...
/**
 * AD_NH_V4 computes the stress following elasticity
 * theory for finite strains
 */
class AD_NH_V4 : public ADComputeStressBase, public GuaranteeConsumer
{
public:
  static InputParameters validParams();

  AD_NH_V4(const InputParameters & parameters);
