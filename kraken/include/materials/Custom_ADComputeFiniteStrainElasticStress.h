 ...
 */
class Custom_ADComputeFiniteStrainElasticStress : public ADComputeStressBase, public GuaranteeConsumer
{
public:
  static InputParameters validParams();

  Custom_ADComputeFiniteStrainElasticStress(const InputParameters & parameters);
