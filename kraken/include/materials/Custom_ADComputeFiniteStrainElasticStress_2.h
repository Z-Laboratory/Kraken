...
/**
 * Custom_ADComputeFiniteStrainElasticStress computes the stress following elasticity
 * theory for finite strains
 */
class Custom_ADComputeFiniteStrainElasticStress_2 : public ADComputeStressBase, public GuaranteeConsumer
{
public:
  static InputParameters validParams();

  Custom_ADComputeFiniteStrainElasticStress_2(const InputParameters & parameters);
